...
- **AfuSINE2** (Kanhayuwa & Coutts 2016) — checked Supporting Information S13 (a PDF) directly: contains only short PCR validation primers (18-22 bp), not full consensus sequences. Remains figure-only.
- **SINEU** (Kojima 2015) — checked Europe PMC's supplementary-files bundle: zero supplementary data files exist for this paper at all (only main-text figures). Remains figure-only, confirmed nothing further to check.
